...
#'
#' Likelihood function and random number generator for the 2DSD Model presented
#' by Pleskac & Busemeyer (2010). It includes following parameters:
...
#'
#' For the confidence part \code{tau} (post-decisional accumulation time),
...
#'
#' The 2DSD is an extension of the Ratcliff model to explain confidence judgments based
